...
exports.createUserZodSchema = zod_1.default.object({
    name: zod_1.default.string().min(2, { message: "Name must be at least 2 characters long." }).max(50),
    email: zod_1.default.string().email({ message: "Invalid email address format." }).min(5).max(100),
